...
# Welcome to the Flutterism

Flutterism is an open source repository for building beautiful, natively compiled applications for mobile, web, desktop, and embedded devices from a single codebase.
Flutterism is primarily funded by Google with contributors from all around the world.
...
The Flutterism project has a number of repositories, some important ones include:

<!-- alphabetical -->
* [flutterism](https://github.com/UsamaSarwar/flutterism): the DevTools tooling (performance tools, inspector, debugger).
